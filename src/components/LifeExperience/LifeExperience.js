        ...
        return (
            <div className='LifeExperience' name='LifeExperience'>
                ...
                <div className='LifeExperienceTitle'>  < h2> Business In Fashion </h2> </div>
                    ...
                    <img className='wwd' src={WWD} alt='WWD' onClick= {'https://wwd.com/fashion-news/shows-reviews/gallery/romeo-hunte-rtw-fall-1203013267/romeo-hunte-rtw-fall-2019-21/'} />
